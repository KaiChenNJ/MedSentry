...
import pandas as pd
import time
from structures.decentralized import DecentralizedStructure
...
def main():
    """
    Run the decentralized structure system
    """
    parser = argparse.ArgumentParser(description="Run decentralized structure system")
    ...
    parser.add_argument("--output_dir", type=str, default="results/decentralized", help="Output directory")
